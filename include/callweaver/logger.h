...
/*!
	...
	cw_log(LOG_WHATEVER, "Problem with the %s Captain.  We should get some more.  Will %d be enough?\n", "flux capacitor", 10);
 ...
 */
extern void cw_log(int level, const char *file, int line, const char *function, const char *fmt, ...)
